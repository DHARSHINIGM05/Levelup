  ...
  return (
    <div>
      ...
      <p style={{ fontSize: "1.1rem", color: "#333", marginBottom: 16 }}>
        {level} Grade {grade} – Hear the word, then say it out loud. The app
        will listen to you.
      </p>
      {!supported && (
        <p style={{ color: "#E67E22", marginBottom: 16, fontWeight: 700 }}>
          Your browser may not support voice input. Try Chrome or Edge for best
          results.
        </p>
      )}
